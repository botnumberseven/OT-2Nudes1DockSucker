...
cp /root/OT-2Nodes1Server/dockerless/otnode.service /lib/systemd/system/$NODE_ID.service
...
cp /root/OT-2Nodes1Server/dockerless/start-script $DEST_DIR/$NODE_ID
